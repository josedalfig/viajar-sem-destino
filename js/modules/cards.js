    ...
    document.getElementById('detP').innerHTML =
      ...
      + '<div class="dp-stats">'
        + '<div class="dst dp-total-stat">'
          + '<div class="dsl">Total da viagem (' + passengers + ' pax)</div>'
        ...
        + '<div class="dst"><div class="dsl">Volta</div><div class="dsv">' + (soIda ? 'Só ida' : fmtD(volta)) + '</div></div>'
